...
# %%
# Function that requests data from sdate to edate
...
#%%
# DATE RANGE that varies within an hour
...
# %%
# Main function that gathers data within the date range and inserts them inside the DB
